...
urlpatterns = [
    ...
    path('admin/users/<int:pk>/', views.UserDelete.as_view(), name='user-delete'),
    path('admin/branches/', views.BranchListCreate.as_view(), name='branch-list-create'),
    path('admin/branches/<int:pk>/', views.BranchDetail.as_view(), name='branch-detail'),
    ...
    path('admin/subcategories/<int:pk>/', views.SubcategoryDetail.as_view(), name='subcategory-detail'),
    path('admin/products/', views.ProductListCreate.as_view(), name='product-list-create'),
    path('admin/products/<int:pk>/', views.ProductDetail.as_view(), name='product-detail'),
